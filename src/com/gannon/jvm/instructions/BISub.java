...
public class BISub extends BInstruction {

	public BISub(int lineNumber) {
		super(lineNumber);
	...
	public void analyzing(DependencyFrame rFrame) {
		...
		Integer sub = secondValue-firstValue;
		valueStack.push(sub);
		...
		BinNode rootNode=new BinNode(Integer.toString(OpcodeUtility.getNextID()), sub);
