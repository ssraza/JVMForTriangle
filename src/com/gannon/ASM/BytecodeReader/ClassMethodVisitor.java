...
import com.gannon.ASM.BytecodeComponent.BLineNumber;
...
public class ClassMethodVisitor extends MethodVisitor {
	...
	public void visitFieldInsn(int opcode, String owner, String name,
		...
		System.out.println(": " + new HardBytecode().getStringByteCode(opcode)
				+ "  " + owner + "  " + name + "  " + desc + "  " + linNumber);
	...
	public void visitJumpInsn(int opcode, Label label) {
		// currentMethod.addInstruction(new BInstruction(opcode, label));
		// currentMethod.addJumpInstructions(new BJumpInstructions(opcode,
		// label));
	...
	public void visitLabel(Label label) {
		currentBlock = new BBlock(label);
		currentBlock.setNewLableName("L"+blockID);
		//System.out.println("fddsfsdafdsafaf "+label.getOffset());
